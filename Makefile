...
SRC = main.cpp Game.cpp Player.cpp Object.cpp Platform.cpp Level_Loader.cpp Level.cpp Menu.cpp Obstacle.cpp Spike.cpp Water.cpp Lava.cpp One_Way_Platform.cpp Jump_Pad.cpp save_data.cpp save_manager.cpp Collectable.cpp Sun.cpp Heart.cpp
OUT = test1.out
