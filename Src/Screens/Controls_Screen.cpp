...
Controls_Screen::Controls_Screen(sf::Font &font, sf::Vector2u window_size)
{
    ...
    controls_text.setString("CONTROLS:\n"
                            ...
                            "Hazards:\n"
                            " - Lava: Hazard that damages you heavily\n"
                            " - Spike: Hazard that damages you\n"
                            "\n"
                            "Objects:\n"
                            " - Water: Heals the player the first time. Allows you to swim but slows you down\n"
                            " - Jump Pad: Boosts the player's vertical jump\n"
                            " - One Way Platform: Platform that allows for the player to jump through the bottom\n"
                            "\n"
                            "Collectables:\n"
